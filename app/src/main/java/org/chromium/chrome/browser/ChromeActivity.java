...
public abstract class ChromeActivity extends AsyncInitializationActivity
        ...
        ContextualSearchTabPromotionDelegate, SnackbarManageable, SceneChangeObserver, Serializable{
    ...
    protected final void setContentView() {
        ...
        if (warmupManager.hasViewHierarchyWithToolbar(controlContainerLayoutId)) {
            ...
            try {
                ...
                // TODO:3 create variables for design elements
                TintedImageButton mMenuBottomButton = findViewById(R.id.menu_bottom_button);
                RelativeLayout rt = findViewById(R.id.nav_bar);
                ImageButton close, history, bookmark, incognito;

                View handler = findViewById(R.id.handler_view);

                close = findViewById(R.id.Btn_close);
                history = findViewById(R.id.Btn_history);
                bookmark = findViewById(R.id.Btn_bookmark);
                incognito = findViewById(R.id.Btn_incognito);

                //TODO:10 handle background click to hide Expandable navigation bar
                ...
                // TODO:4 handle close button
                close.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
//                        rt.animate()
//                                .translationY(rt.getHeight())
//                                .alpha(0.0f)
//                                .setDuration(300)
...
//                                });
                ...
                // TODO:7 handle incognito button
                incognito.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        rt.setVisibility(View.GONE);
                        handler.setVisibility(View.GONE);
                        onMenuOrKeyboardAction(R.id.new_incognito_tab_menu_id, false);

                    }
                });

                // TODO:8 handle button that open Expandable navigation bar
                mMenuBottomButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
